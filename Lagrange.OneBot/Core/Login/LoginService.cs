    ...
    public async Task StartAsync(CancellationToken token)
    {
        ...
        bool isSucceed = await FallbackAsync.Create()
            ...
            .Add(async (token) =>
            {
                ...
                // 不太确定这两句是不是真的还需要
                _logger.LogInformation($"Please scan the QR code above, Url: {qrcode.Value.Url}");
                ...
                _logger.LogInformation($"[X] qrcode file generated: qr-{configuration["Account:Uin"]}.png");
